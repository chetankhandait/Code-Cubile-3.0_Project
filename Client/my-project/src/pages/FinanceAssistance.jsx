...
const FinanceAssistance = () => {
  return (
    <div className="flex flex-col lg:flex-row bg-gray-50 min-h-screen">
      {/* Sidebar */}
      <div className="w-full lg:w-1/4 h-screen bg-white p-6 flex flex-col shadow-lg">
        {/* Navigation Links */}
        ...
        <div className="mt-auto">
          ...
          <div className="space-y-4">
            {/* Notification 1 */}
            <div className="flex items-center p-4 bg-white rounded-lg shadow hover:shadow-md transition-all">
              <span className="p-2 rounded-full bg-gray-100 mr-3">
                <MdNotifications className="w-6 h-6 text-gray-800" />
              </span>
